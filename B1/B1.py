...
def main():
    ...
    with open(train_label_path, "r") as read_file:
        ...
        for i in range(1, len(lines)):
            ...
            name = values[3]#serial numbers stored in the fourth column
            face = int(values[2])
            train_name2label[name] = face
    ...
    with open(test_label_path, "r") as read_file:
        ...
        for i in range(1, len(lines)):
            ...
            values = line.strip().split("\t")
            name = values[3]# serial numbers stored in the fourth column
            face = int(values[2])# labels stored in the third column
            test_name2label[name] = face
    ...
    class CartoonDataset(Dataset):
        #Custom Dataset for loading cartoon_set
